  ...
  return (
    <section className="max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row">
      ...
      <div className="relative z-20 flex flex-col flex-1 xl:w-1/2">
        <Image src='/camp.svg' alt="Camp" width={50} height={50} className="absolute left-[-5px] top-[-30px] w-10 lg:w-[50px] pointer-events-none select-none" />
        ...
        <div className="my-11 flex flex-wrap gap-5">
          <div className="flex items-center gap-2">
            {Array(5).fill(1).map((_, index) => (
              <Image src='/star.svg' alt="Stars" className="pointer-events-none select-none" width={24} height={24} key={index} />
            ))}
          </div>
